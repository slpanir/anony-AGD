...
def load_classifiers(save_path, k):
    ...
    C_helpful = data["C_helpful_top_k"]
    target_heads = [c[0] for c in data["C_helpful_top_k"][:min(k, max_num)]]
...
def main(generator_save_path, classifier_save_path, args):
    ...
    folder_path = "../exp_outputs/advGAME/llama2_new/tt-het-0.03-" + f'{args.defender if args.is_defense else "nodefense"}_{args.model_name}_{args.attacker}_{args.num_prompts}_{time_str}'
